...
const CACHE_NAME = 'loan-tracker-cache-v22'; // เพิ่มเลขนี้ทุกครั้งที่อัปเดตไฟล์ เพื่อบังคับเครื่องผู้ใช้ดึงเวอร์ชันใหม่
const ASSETS = [
  './loan_tracker.html',
  './styles.css?v=22',
  './js/app.js?v=22',
  ...
  './js/sync-version.js',
  './js/loan-analytics.js?v=22',
  './js/receipt-store.js?v=22',
  './js/encrypted-backup.js?v=22',
  './manifest.json',
  './icon-192.png',
  './icon-512.png',
