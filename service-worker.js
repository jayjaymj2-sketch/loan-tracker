...
const CACHE_NAME = 'loan-tracker-cache-v19'; // เพิ่มเลขนี้ทุกครั้งที่อัปเดตไฟล์ เพื่อบังคับเครื่องผู้ใช้ดึงเวอร์ชันใหม่
const ASSETS = [
  './loan_tracker.html',
  './styles.css?v=19',
  './js/app.js?v=19',
  ...
  './js/sync-version.js',
  './js/loan-analytics.js?v=19',
  './js/receipt-store.js?v=19',
  './js/encrypted-backup.js?v=19',
  './manifest.json',
  './icon-192.png',
  './icon-512.png',
